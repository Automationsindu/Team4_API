...
public void dietician_send_get_http_request_with_endpoint() throws com.fasterxml.jackson.databind.exc.InvalidFormatException, IOException {
...
public void admin_send_get_http_request_with_endpoint() throws com.fasterxml.jackson.databind.exc.InvalidFormatException, IOException {
	response=patient_Actions.Get_Patient_AllTest(reqSpec, currentTag);
}
...
public void patient_send_get_http_request_with_endpoint() throws com.fasterxml.jackson.databind.exc.InvalidFormatException, IOException {
	response=patient_Actions.Get_Patient_AllTest(reqSpec, currentTag);
}
